...
namespace SupermarketReceipt.Test
{
    public class ShoppingCartTest
    {
        ...
        public ShoppingCartTest(ITestOutputHelper output)
        {
            ...
            _mockOffer.Add(new Product("icecream", ProductUnit.Each), new Offer(SpecialOffers.TenPercentDiscount, new Product("icecream", ProductUnit.Each), 1, 0.10, 0)); // tenPercentDiscount
            _mockOffer.Add(new Product("cream puff", ProductUnit.Each), new Offer(SpecialOffers.FiveItemsForSpecificPrice, new Product("cream puff", ProductUnit.Each), 5, 0, 4.50)); // fiveItemForSale 
            _mockOffer.Add(new Product("souffle", ProductUnit.Each), new Offer(SpecialOffers.TwentyPercentDiscount, new Product("souffle", ProductUnit.Each), 1, 0.20 , 0)); // twentyPercentDiscount
